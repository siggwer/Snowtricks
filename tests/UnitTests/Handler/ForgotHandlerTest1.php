...
/**
 * Class ForgotHandlerTest1
 *
 * @package App\Tests\UnitTests\Handler
 */
class ForgotHandlerTest1 extends TestCase
{
    /**
     *
     */
...
//    }
    ...
    public function testHandlerIsTrue()
    {
        ...
        $this->assertTrue(true, $forgotPasswordHandler->handle(
         $form, new Forgot()
        ));

//        $handler = new ForgotHandler(
...
//
//        $this->assertTrue(
//            $handler->handle($this->createMock(Request::class), $handler)
//        );
    }
